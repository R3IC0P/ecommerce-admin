  ...
  return (
    <aside className="flex flex-col gap-5 h-full w-60 p-5 bg-neutral-50 border border-neutral-300 dark:bg-neutral-950 dark:border-neutral-800">
      ...
      <Input
        ...
        size="sm"
        placeholder="Szukaj"
        startContent={<MagnifierIcon />}
      />
      <Listbox>
        <ListboxItem startContent={<HomeIcon />}>Home</ListboxItem>
        <ListboxItem startContent={<DashboardIcon />}>Panel</ListboxItem>
        <ListboxItem startContent={<CartIcon />}>Zamówienia</ListboxItem>
        <ListboxItem startContent={<MagazineIcon />}>Magazyn</ListboxItem>
        <ListboxItem startContent={<TaskListIcon />}>Zadania</ListboxItem>
        <ListboxItem startContent={<ChatIcon />}>Wiadomości</ListboxItem>
        <ListboxItem startContent={<UsersIcon />}>Użytkownicy</ListboxItem>
      </Listbox>
      <Listbox className="mt-auto">
        <ListboxItem startContent={<QuestionMarkIcon />}>Pomoc</ListboxItem>
        <ListboxItem startContent={<CogWheelIcon />}>Ustawienia</ListboxItem>
      </Listbox>
